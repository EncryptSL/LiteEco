...
class EcoCMD(
    ...
    override fun execute(commandManager: PaperCommandManager<Source>) {
        commandManager.buildAndRegister("eco", Description.description(DESCRIPTION)) {
            ...
            val debugSubCommand = commandBuilder.literal("debug")

            commandManager.command(debugSubCommand.literal("failmode")
            ...
            commandManager.command(debugSubCommand.literal("test-janitor")
            ...
            commandManager.command(debugSubCommand.literal("janitor")
            ...
            commandManager.command(debugSubCommand.literal("inspect")
            ...
            commandManager.command(debugSubCommand.literal("stress")
